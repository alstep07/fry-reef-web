...
const manifest = {
  ...
  miniapp: {
    ...
    subtitle: "An on-chain game where you breed, merge, and evolve fish",
    ...
    ogTitle: "FryReef",
    ogDescription: "Build your underwater reef by breeding and evolving fish NFTs. Free starter pack, daily rewards, and idle gameplay on Base.",
